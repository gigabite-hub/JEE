...
.table-wrapper-old table tbody tr td:nth-child(3),
.table-wrapper-old table thead tr th:nth-child(3){
...
<div class="pricing-wrapper">
    ...
    <div class="pricing-container">
        ...
        <div class="heading-section">
            ...
            <div class="head-item"><h1>Non-Profit Plans</h1></div>
            <div class="head-item"><hr></div>
        </div>
            ...
            <div class="table-wrapper-old">
                <table>
                    ...
                    <tr class="pricing-section">
                        ...
                        <th>
                            <h4>PLUS</h4>
                            <h4>$139 <sub>/mo</sub></h4>
                        </th>
                        <th>
                            <h4>PRO</h4>
                            <h4>$249 <sub>/mo</sub></h4>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                        <tr class="feature-details">
                            <td>
                                <dl class="feature-label">
                                    <dt class="feature-label__text"><a href="https://jee.jibbio.com/MAXeSites.php" target="_blank">MAXeSites</a></dt>
                                </dl>
                            </td>
                            <td>
                                <span>60</span>
                        ...
                        <tr class="feature-details">
                            <td>
                                <dl class="feature-label">
                                    <dt class="feature-label__text">Predesigned Templates</dt>
                                </dl>
                            </td>
                            <td>
                                <span></span>
                        ...
                        <tr class="feature-details">
                            <td>
                                <dl class="feature-label">
                                    <dt class="feature-label__text"><a href="https://non-profit-custom-branding.maxesite.com/" target="_blank">Done-For-You Branding</a></dt>
                                </dl>
                            </td>
                            <td>
                                <span></span>
                            ...
                            <td>
                                <span>3 custom templates</span>
                            </td>
                        </tr>
                        <tr class="feature-details">
                            <td>
                                <dl class="feature-label">
                                    <dt class="feature-label__text"><a href="https://donateandgive.com/how-it-works/non-profit" target="_blank">DonateandGive.com</a></dt>
                                </dl>
                            </td>
                            <td>
                            ...
                            <td>
                                <span>Gold listing</span>
                            </td>
                            <td>
                                <span>Platinum listing</span>
                            </td>
                        </tr>
                        <tr class="feature-details">
                            <td>
                                <dl class="feature-label">
                                    <dt class="feature-label__text"><a href="https://jee.jibbio.com/save-raise-program-boost-non-dues-revenue-non-profits.php" target="_blank">Save-Raise Program</a></dt>
                                </dl>
                            </td>
                            <td>
                                <span><i style="font-size:30px;color:#0188CA;" class="fa fa-check-circle lazy" alt="Create an ecommerce online store" title="Create an ecommerce online store" ></i></span>
                        ...
                        <tr class="feature-details">
                            <td>
                            <dl class="feature-label">
                                <dt class="feature-label__text"><a href="https://jee.jibbio.com/3-in-1-qr-codes.php" target="_blank">3-in-1 QR Codes</a></dt>
                            </dl>
                            </td>
                            <td>
                                <span><i style="font-size:30px;color:#0188CA;" class="fa fa-check-circle lazy" alt="Create an ecommerce online store" title="Create an ecommerce online store" ></i></span>
